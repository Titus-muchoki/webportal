    ...
    return (
        <div className='max-w-[1240px] mx-auto py-16 px-4 grid lg:grid-cols-3 gap-8 text-gray-300'>
            <div>
                ...
                <p className='py-4'>
                    Lorem, ipsum dolor sit amet consectetur adipisicing elit. Voluptas cumque facere, distinctio aliquid accusamus aut nam iste reprehenderit sunt repudiandae doloremque libero dicta, earum nisi. Dolorum nulla voluptate nostrum ex.
                </p>
